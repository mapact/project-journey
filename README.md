# project-journey - Azure Migration program
...
| **Governance** | <ul><li>[Build a governance strategy](https://docs.microsoft.com/en-us/learn/modules/build-cloud-governance-strategy-azure/)</li></ul>  |
| **Cost Management** | <ul><li>[Predict Cost and optimize spending](https://docs.microsoft.com/en-us/learn/modules/predict-costs-and-optimize-spending)</li></ul> |
| **Policies** | <ul><li>[Sample repository](https://github.com/Azure/azure-policy)</li><li>[community repository](https://github.com/Azure/Community-Policy)</li><li>[Policy and github](https://docs.microsoft.com/en-us/azure/governance/policy/tutorials/policy-as-code-github)</li><li>[Apply and monitor infrastructure standard with Azure Policy](https://docs.microsoft.com/en-us/learn/modules/intro-to-governance/)</li></ul>  |
